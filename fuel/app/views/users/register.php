              	...
              	<fieldset>
						<div class="form-group">
							<?php echo Form::label('Facebook', 'facebook', array('class'=>'control-label')); ?>
								<?php echo Form::input('facebook', Input::post('facebook', isset($user) ? $user->facebook : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Facebook')); ?>
						</div>

						<div class="form-group">
							<?php echo Form::label('Twitter', 'twitter', array('class'=>'control-label')); ?>
								<?php echo Form::input('twitter', Input::post('twitter', isset($user) ? $user->twitter : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Twitter')); ?>
						</div>

						<div class="form-group">
							<?php echo Form::label('LinkedIn', 'linkedin', array('class'=>'control-label')); ?>
								<?php echo Form::input('linkedin', Input::post('linkedin', isset($user) ? $user->linkedin : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'LinkedIn')); ?>
						</div>
